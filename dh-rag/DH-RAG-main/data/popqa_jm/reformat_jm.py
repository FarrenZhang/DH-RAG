...
input_data = []
with open('popqa_test_0808.jsonl', 'r') as f:
    for line in f:
...
with open('transformed_popqa_0812.json', 'w') as f:
    json.dump(grouped_data, f, indent=2)

print("Grouped conversations have been written to 'transformed_popqa_0812.json'")