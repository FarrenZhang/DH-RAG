...
RETRIEVAL_DATABASE_PATH = "/home/dh-rag/data/mobilecs2_data/triviaqa_jm/retrieval_database.jsonl"
QUERY_CONTEXT_MAPPING_PATH = "/home/dh-rag/data/mobilecs2_data/triviaqa_jm/query_context_mapping.json"
...
if __name__ == "__main__":
    ...
    BASE_DIR = args.output_dir if args.output_dir else "./trivia_qa"
    INPUT_DIR = os.path.join(BASE_DIR, "input")
    OUTPUT_DIR = BASE_DIR
    LOG_DIR = os.path.join(BASE_DIR, "logs")
